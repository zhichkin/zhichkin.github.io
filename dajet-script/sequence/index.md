...
![apply-sequence](/dajet-script/sequence/img/apply-sequence-01.png)

В результате выполнения в пустом регистре будет создана одна запись и получена следующая ошибка:

![apply-sequence](/dajet-script/sequence/img/apply-sequence-02.png)

![apply-sequence](/dajet-script/sequence/img/apply-sequence-03.png)
...
![apply-sequence](/dajet-script/sequence/img/apply-sequence-04.png)
